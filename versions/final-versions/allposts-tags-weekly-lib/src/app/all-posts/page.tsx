      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center p-6 bg-black">
        ...
        <div className="flex gap-3">
          {!user ? (
            <>
              <Link href="/login">
                <button className="bg-gray-700 text-white border-gray-600 hover:bg-gray-600 rounded-full px-6 py-2">
                  Iniciar sesión
                </button>
              </Link>
              <Link href="/signup">
                <button className="bg-gray-700 text-white hover:bg-gray-600 rounded-full px-6 py-2">
                  Registrarse
                </button>
              </Link>
            </>
